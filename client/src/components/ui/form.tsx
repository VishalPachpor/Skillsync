...
>(({ className, colSpan = "full", ...props }, ref) => {
  const id = React.useId();

  // Calculate column span classes based on colSpan prop
  const getColSpanClass = () => {
    if (colSpan === "full") return "md:col-span-12";
  ...
  return (
    <FormItemContext.Provider value={{ id }}>
      <div
        ref={ref}
        className={cn("space-y-2 w-full md:mb-0", getColSpanClass(), className)}
        {...props}
      />
